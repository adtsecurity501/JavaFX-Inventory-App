...
public class DispositionInfo {
    ...
    public void setEveron(boolean everon) {
        isEveron = everon;
    }
    ...
    public void setUnderCapacity(boolean underCapacity) {
        isUnderCapacity = underCapacity;
    }

    public String getOtherDisqualification() {
        return otherDisqualification;
    }

    public void setOtherDisqualification(String otherDisqualification) {
        this.otherDisqualification = otherDisqualification;
    }
}