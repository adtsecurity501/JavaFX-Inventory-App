...
public class AutofillManagementController {
    ...
    public void initialize() {
        ...
        searchField.textProperty().addListener((obs, oldVal, newVal) -> filteredData.setPredicate(asset -> {
            ...
            return (asset.getSerialNumber() != null && asset.getSerialNumber().toLowerCase().contains(lower)) ||
                    (asset.getMake() != null && asset.getMake().toLowerCase().contains(lower)) ||
                    (asset.getModelNumber() != null && asset.getModelNumber().toLowerCase().contains(lower)) ||
                    (asset.getDescription() != null && asset.getDescription().toLowerCase().contains(lower)) ||
